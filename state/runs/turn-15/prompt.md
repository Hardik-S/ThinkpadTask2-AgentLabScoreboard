...
Task:
Rewrite complete app.js to add token and cost estimate rendering. Use honest approximate fields and mark unknown values clearly. Preserve existing rendering behavior.
