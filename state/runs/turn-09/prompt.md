...
Task:
Write complete app.js skeleton that loads local scoreboard data from an embedded fallback constant first. Include functions for rendering table, metrics, cards, lessons, estimates, and states. No network calls.
