...
Turn: 19/24.
Target file: docs/turn-19-polish-copy.md
...
Task:
Write concise copy polish recommendations for the current dashboard. Suggest exact wording, but do not edit runtime files in this turn. Markdown only under 500 words.
