...
(no raw project files yet)

Task:
Write the raw project README for Local Agent Lab Scoreboard. Explain the raw Qwen boundary, offline static dashboard purpose, Task 1 seed evidence, and future extensibility. Markdown only.
