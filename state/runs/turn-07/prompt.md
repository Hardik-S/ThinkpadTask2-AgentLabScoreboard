...
Task:
Write complete index.html for an offline static dashboard. Link styles.css and app.js. Use semantic regions and accessible headings. No external assets, no CDN, no network calls.
