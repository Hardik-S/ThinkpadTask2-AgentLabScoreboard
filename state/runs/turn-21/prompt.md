...
Task:
Rewrite the README with final raw-worker status language. Keep raw boundary, future additions, validation expectations, and Codex repair boundary clear. Markdown only.
