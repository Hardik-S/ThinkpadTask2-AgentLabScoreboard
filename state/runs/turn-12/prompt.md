...
Turn: 12/24.
Target file: docs/accessibility-notes.md
...
Task:
Write accessibility notes for the dashboard: landmarks, heading order, table captions, focus states, contrast, and empty states. Markdown only.
