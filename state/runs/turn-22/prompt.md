...
Turn: 22/24.
Target file: docs/handoff-to-codex.md
...
Task:
Write final handoff notes for Codex. Include what exists, what might be broken, what to validate, and why raw output must remain frozen. Markdown only under 450 words.
