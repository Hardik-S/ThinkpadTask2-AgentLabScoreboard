...
Turn: 18/24.
Target file: docs/raw-validation-report.md
...
Task:
Write a raw validation report template that says Codex must run it after turn 24. Do not claim checks passed yet. Markdown only.
