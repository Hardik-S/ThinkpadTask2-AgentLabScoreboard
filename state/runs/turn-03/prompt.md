...
Turn: 3/24.
Target file: data/scoreboard.json
...
Task:
Write valid JSON only. Create an array with one run record for Task 1 using the provided facts. Include room for future runs. No prose, no fences.
