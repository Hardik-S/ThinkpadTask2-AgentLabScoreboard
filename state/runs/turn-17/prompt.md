...
Task:
Write complete CommonJS validator. Check required files, parse data/scoreboard.json, run node --check app.js, and scan project files for http://, https://, cdn, api_key, secret, password, token. No markdown fences.
